...
"es": {
"A1": [
  [("Hello","Hola"),("Goodbye","Adi\u00f3s"),("Good morning","Buenos d\u00edas"),("Good afternoon","Buenas tardes"),("Good night","Buenas noches"),("Please","Por favor"),("Thank you","Gracias"),("Sorry","Lo siento"),("Excuse me","Disculpe"),("Yes","S\u00ed"),("No","No")],
...
"B2": [
  ...
  [("To break the ice","Romper el hielo"),("To hit the nail on the head","Dar en el clavo"),("A piece of cake","Pan comido"),("To cost an arm and a leg","Costar un ojo de la cara"),("Better late than never","M\u00e1s vale tarde que nunca"),("To be on cloud nine","Estar en el s\u00e9ptimo cielo"),("To pull someone\u0027s leg","Tomar el pelo"),("Once in a blue moon","De higos a brevas"),("To let the cat out of the bag","Descubrir el pastel"),("To kill two birds with one stone","Matar dos p\u00e1jaros de un tiro"),("The ball is in your court","La pelota est\u00e1 en tu tejado"),("Bite off more than you can chew","Quien mucho abarca poco aprieta")],
...
"fr": {
"A1": [
  [("Hello","Salut"),("Goodbye","Au revoir"),("Good morning","Bonjour"),("Good evening","Bonsoir"),("Good night","Bonne nuit"),("Please","S\u0027il vous pla\u00eet"),("Thank you","Merci"),("Sorry","D\u00e9sol\u00e9"),("Excuse me","Excusez-moi"),("Yes","Oui"),("No","Non")],
...
"A2": [
  ...
  [("Happy","Heureux"),("Sad","Triste"),("Angry","En col\u00e8re"),("Worried","Inquiet"),("Excited","Enthousiaste"),("Shy","Timide"),("Brave","Courageux"),("Kind","Gentil"),("Generous","G\u00e9n\u00e9reux"),("Lazy","Paresseux"),("Patient","Patient"),("Proud","Fier")],
...
"B2": [
  ...
  [("To break the ice","Das Eis brechen"),("To hit the nail on the head","Den Nagel auf den Kopf treffen"),("A piece of cake","Ein Kinderspiel"),("To cost an arm and a leg","Ein Verm\u00f6gen kosten"),("Better late than never","Besser sp\u00e4t als nie"),("To be on cloud nine","Auf Wolke sieben sein"),("To pull someone\u0027s leg","Jemanden auf den Arm nehmen"),("Once in a blue moon","Alle Jubeljahre"),("To let the cat out of the bag","Die Katze aus dem Sack lassen"),("To kill two birds with one stone","Zwei Fliegen mit einer Klappe schlagen"),("The ball is in your court","Der Ball liegt bei dir"),("Bite off more than you can chew","Sich zu viel vornehmen")],
...
"A1": [
  [("Hello","Ol\u00e1"),("Goodbye","Adeus"),("Good morning","Bom dia"),("Good afternoon","Boa tarde"),("Good night","Boa noite"),("Please","Por favor"),("Thank you","Obrigado"),("Sorry","Desculpe"),("Excuse me","Com licen\u00e7a"),("Yes","Sim"),("No","N\u00e3o")],
  ...
  [("House","Casa"),("Room","Sala"),("Kitchen","Cozinha"),("Bathroom","Banheiro"),("Bedroom","Quarto"),("Door","Porta"),("Window","Janela"),("Table","Mesa"),("Chair","Cadeira"),("Bed","Cama"),("Garden","Jardim")],
...
"B2": [
  ...
  [("To break the ice","Quebrar o gelo"),("To hit the nail on the head","Acertar em cheio"),("A piece of cake","Moleza"),("To cost an arm and a leg","Custar os olhos da cara"),("Better late than never","Antes tarde do que nunca"),("To be on cloud nine","Estar no s\u00e9timo c\u00e9u"),("To pull someone\u0027s leg","Pegar no p\u00e9 de algu\u00e9m"),("Once in a blue moon","Uma vez na vida, outra na morte"),("To let the cat out of the bag","Dar com a l\u00edngua nos dentes"),("To kill two birds with one stone","Matar dois coelhos com uma cajadada"),("The ball is in your court","A bola est\u00e1 com voc\u00ea"),("Bite off more than you can chew","Dar um passo maior que a perna")],
...
"A1": [
  ...
  [("House","\u5bb6"),("Room","\u90e8\u5c4b"),("Kitchen","\u53f0\u6240"),("Bath","\u304a\u98a8\u5442"),("Bedroom","\u5bdd\u5ba4"),("Door","\u30c9\u30a2"),("Window","\u7a93"),("Table","\u30c6\u30fc\u30d6\u30eb"),("Chair","\u6905\u5b50"),("Bed","\u30d9\u30c3\u30c9"),("Garden","\u5ead")],
...
"A2": [
  ...
  [("Happy","\u5b09\u3057\u3044"),("Sad","\u60b2\u3057\u3044"),("Angry","\u6012\u3063\u3066\u3044\u308b"),("Worried","\u5fc3\u914d"),("Excited","\u30ef\u30af\u30ef\u30af\u3059\u308b"),("Embarrassed","\u6065\u305a\u304b\u3057\u3044"),("Brave","\u52c7\u6562"),("Kind","\u512a\u3057\u3044"),("Generous","\u5bdb\u5927"),("Lazy","\u6020\u3051\u308b"),("Patient","\u5fcd\u8010\u5f37\u3044"),("Proud","\u8a87\u308a\u306b\u601d\u3046")],
...
"B2": [
  ...
  [("Argument","\u8b70\u8ad6"),("To persuade","\u8aac\u5f97\u3059\u308b"),("Evidence","\u8a3c\u62e0"),("Counterargument","\u53cd\u8ad6"),("However","\u3057\u304b\u3057"),("Nevertheless","\u305d\u308c\u3067\u3082"),("Furthermore","\u3055\u3089\u306b"),("To refute","\u53cd\u99c1\u3059\u308b"),("Claim","\u4e3b\u5f35"),("Fallacy","\u8a6d\u5f01"),("Rhetoric","\u4fee\u8f9e\u5b66"),("Bias","\u504f\u898b")],
  ...
  [("To break the ice","\u5834\u3092\u548c\u307e\u305b\u308b"),("To hit the nail on the head","\u7684\u3092\u5c04\u308b"),("A piece of cake","\u671d\u98ef\u524d"),("To cost an arm and a leg","\u76ee\u306e\u7389\u304c\u98db\u3073\u51fa\u308b"),("Better late than never","\u9045\u304f\u3066\u3082\u3057\u306a\u3044\u3088\u308a\u307e\u3057"),("To be on cloud nine","\u5929\u306b\u3082\u6607\u308b\u6c17\u6301\u3061"),("To pull someone\u0027s leg","\u304b\u3089\u304b\u3046"),("Once in a blue moon","\u3081\u3063\u305f\u306b"),("To let the cat out of the bag","\u53e3\u3092\u6ed1\u3089\u3059"),("To kill two birds with one stone","\u4e00\u77f3\u4e8c\u9ce5"),("The ball is in your court","\u3042\u306a\u305f\u6b21\u7b2c"),("Bite off more than you can chew","\u80fd\u529b\u4ee5\u4e0a\u306e\u3053\u3068\u3092\u3059\u308b")],
...
"A1": [
  ...
  [("Water","\ubb3c"),("Chicken","\ub2ed\uace0\uae30"),("Bread","\ube75"),("Apple","\uc0ac\uacfc"),("Milk","\uc6b0\uc720"),("Coffee","\ucee4\ud53c"),("Cheese","\uce58\uc988"),("Rice","\ubc25"),("Fish","\uc0dd\uc120"),("Delicious","\ub9db\uc788\ub294"),("Menu","\uba54\ub274")],
  [("Left","\uc67c\ucabd"),("Right","\uc624\ub978\ucabd"),("Straight","\uc9c1\uc9c4"),("Bus","\ubc84\uc2a4"),("Train","\uae30\ucc28"),("Ticket","\ud45c"),("Station","\uc5ed"),("Hospital","\ubcd1\uc6d0"),("Bank","\uc740\ud589"),("Pharmacy","\uc57d\uad6d"),("Airport","\uacf5\ud56d")],
  [("Breakfast","\uc544\uce68 \uc2dd\uc0ac"),("Expensive","\ube44\uc2fc"),("Cheap","\uc2fc"),("Red","\ube68\uac04\uc0c9"),("Blue","\ud30c\ub780\uc0c9"),("Shirt","\uc154\uce20"),("Shoes","\uc2e0\ubc1c"),("To pay","\uacc4\uc0b0\ud558\ub2e4"),("Time","\uc2dc\uac04"),("Tomorrow","\ub0b4\uc77c"),("Money","\ub3c8")],
  [("Teacher","\uc120\uc0dd\ub2d8"),("Doctor","\uc758\uc0ac"),("Office","\uc0ac\ubb34\uc2e4"),("To read","\uc77d\ub2e4"),("To cook","\uc694\ub9ac\ud558\ub2e4"),("Soccer","\ucd95\uad6c"),("Hot","\ub354\uc6b4"),("Cold","\ucd94\uc6b4"),("Summer","\uc5ec\ub984"),("Winter","\uaca8\uc6b8"),("Friend","\uce5c\uad6c")],
  [("Mother","\uc5b4\uba38\ub2c8"),("Father","\uc544\ubc84\uc9c0"),("Sister","\uc790\ub9e4"),("Brother","\ud615\uc81c"),("Daughter","\ub538"),("Son","\uc544\ub4e4"),("Grandmother","\ud560\uba38\ub2c8"),("Grandfather","\ud560\uc544\ubc84\uc9c0"),("Family","\uac00\uc871"),("Dog","\uac1c"),("Cat","\uace0\uc591\uc774")],
  [("House","\uc9d1"),("Room","\ubc29"),("Kitchen","\ubd80\uc5cc"),("Bathroom","\ud654\uc7a5\uc2e4"),("Bedroom","\uce68\uc2e4"),("Door","\ubb38"),("Window","\ucc3d\ubb38"),("Table","\ud14c\uc774\ube14"),("Chair","\uc758\uc790"),("Bed","\uce68\ub300"),("Garden","\uc815\uc6d0")],
  [("Head","\uba38\ub9ac"),("Hand","\uc190"),("Eye","\ub208"),("Stomach","\ubc30"),("Sick","\uc544\ud508"),("Healthy","\uac74\uac15\ud55c"),("Medicine","\uc57d"),("Pain","\ud1b5\uc99d"),("Fever","\uc5f4"),("Arm","\ud314"),("Leg","\ub2e4\ub9ac")],
],
"A2": [
  ...
  [("Sofa","\uc18c\ud30c"),("Shelf","\uc120\ubc18"),("Lamp","\ub7a8\ud504"),("Carpet","\uce74\ud3ab"),("To clean","\uccad\uc18c\ud558\ub2e4"),("To wash","\uc53b\ub2e4"),("To sweep","\uc4f8\ub2e4"),("To cook","\uc694\ub9ac\ud558\ub2e4"),("Rent","\uc6d4\uc138"),("To move","\uc774\uc0ac\ud558\ub2e4"),("Apartment","\uc544\ud30c\ud2b8"),("Balcony","\ubc1c\ucf54\ub2c8")],
  ...
  [("Bigger","\ub354 \ud070"),("Smaller","\ub354 \uc791\uc740"),("Better","\ub354 \uc88b\uc740"),("Worse","\ub354 \ub098\uc05c"),("Cheaper","\ub354 \uc2fc"),("More expensive","\ub354 \ube44\uc2fc"),("Taller","\ub354 \ud0a4\uac00 \ud070"),("Shorter","\ub354 \ud0a4\uac00 \uc791\uc740"),("Faster","\ub354 \ube60\ub978"),("Slower","\ub354 \ub290\ub9b0"),("The best","\uac00\uc7a5 \uc88b\uc740"),("The worst","\uac00\uc7a5 \ub098\uc05c")],
...
"B1": [
  ...
  [("Would you mind","\uad1c\ucc2e\uc73c\uc2dc\uaca0\uc2b5\ub2c8\uae4c"),("Dear Sir","\uc874\uacbd\ud558\ub294"),("Sincerely","\uc9c4\uc2ec\uc73c\ub85c"),("Regards","\uc548\ubd80 \uc804\ud574\uc8fc\uc138\uc694"),("Kind of","\uc57d\uac04"),("Cool","\uba4b\uc9c4"),("Awesome","\ub300\ubc15"),("Whatever","\uc0c1\uad00\uc5c6\uc5b4"),("No worries","\uac71\uc815\ub9c8"),("Dude","\uc57c"),("Formal","\uacf5\uc2dd\uc801"),("Informal","\ube44\uacf5\uc2dd\uc801")],
],
"B2": [
  ...
  [("To break the ice","\uc5b4\uc0c9\ud55c \ubd84\uc704\uae30\ub97c \uae68\ub2e4"),("To hit the nail on the head","\uc815\uace1\uc744 \ucc0c\ub974\ub2e4"),("A piece of cake","\uc2dd\uc740 \uc8fd \uba39\uae30"),("To cost an arm and a leg","\ub208\uc774 \ud280\uc5b4\ub098\uc62c \uc815\ub3c4\ub85c \ube44\uc2f8\ub2e4"),("Better late than never","\ub2a6\uc5b4\ub3c4 \uc548 \ud558\ub294 \uac83\ubcf4\ub2e4 \ub0ab\ub2e4"),("To be on cloud nine","\ud558\ub298\uc744 \ub0a0 \uac83 \uac19\ub2e4"),("To pull someone\u0027s leg","\ub204\uad70\uac00\ub97c \ub180\ub9ac\ub2e4"),("Once in a blue moon","\uac00\ubb44\uc5d0 \ucf69 \ub098\ub4ef"),("To let the cat out of the bag","\ube44\ubc00\uc744 \ub204\uc124\ud558\ub2e4"),("To kill two birds with one stone","\uc77c\uc11d\uc774\uc870"),("The ball is in your court","\uc774\uc81c \ub124 \ucc28\ub840\ub2e4"),("Bite off more than you can chew","\uac10\ub2f9\ud560 \uc218 \uc5c6\ub294 \uc77c\uc744 \ud558\ub2e4")],
...
"A2": [
  ...
  [("Happy","\u5feb\u4e50"),("Sad","\u4f24\u5fc3"),("Angry","\u751f\u6c14"),("Worried","\u62c5\u5fc3"),("Excited","\u5174\u594b"),("Shy","\u5bb3\u7f9e"),("Brave","\u52c7\u6562"),("Kind","\u5584\u826f"),("Generous","\u5927\u65b9"),("Lazy","\u61d2"),("Patient","\u6709\u8010\u5fc3"),("Proud","\u81ea\u8c6a")],
...
"B1": [
  ...
  [("Once upon a time","\u4ece\u524d"),("Then","\u7136\u540e"),("Suddenly","\u7a81\u7136"),("While","\u5f53\u2026\u7684\u65f6\u5019"),("First","\u9996\u5148"),("Next","\u63a5\u4e0b\u6765"),("Finally","\u6700\u540e"),("Meanwhile","\u4e0e\u6b64\u540c\u65f6"),("Character","\u4eba\u7269"),("Plot","\u60c5\u8282"),("Beginning","\u5f00\u5934"),("Ending","\u7ed3\u5c3e")],
...
"B2": [
  ...
  [("To break the ice","\u6253\u7834\u50f5\u5c40"),("To hit the nail on the head","\u4e00\u9488\u89c1\u8840"),("A piece of cake","\u5c0f\u83dc\u4e00\u789f"),("To cost an arm and a leg","\u4ef7\u683c\u4e0d\u83f2"),("Better late than never","\u8fdf\u5230\u603b\u6bd4\u4e0d\u5230\u597d"),("To be on cloud nine","\u6b23\u559c\u82e5\u72c2"),("To pull someone\u0027s leg","\u5f00\u73a9\u7b11"),("Once in a blue moon","\u5343\u8f7d\u96be\u9022"),("To let the cat out of the bag","\u8bf4\u6f0f\u5634"),("To kill two birds with one stone","\u4e00\u77f3\u4e8c\u9e1f"),("The ball is in your court","\u7403\u5728\u4f60\u624b\u4e0a"),("Bite off more than you can chew","\u8d2a\u591a\u56bc\u4e0d\u70c2")],
...
def generate_exercises_for_lesson(vocab_pairs, level, lesson_idx, num_exercises, lang_name):
    ...
    for ei in range(num_exercises):
        ...
        if ex_type == "multiple_choice":
            # The question is "what does <target> mean in English?", so both the
            # correct answer and the distractors must be ENGLISH. This used to
            # take p[1] (the target-language string), which put four foreign
            # words in the options while correct_answer was English — the answer
            # was not among its own options. Migration 049 hand-patched 79 rows
            # of that; this is the generator-side fix.
            #
            # Distractors are also filtered against `eng` so a word the unit
            # teaches twice (Bonjour = Hello / Good morning) cannot supply a
            # second correct option.
            distractors = [
                p[0] for i, p in enumerate(vocab_pairs)
                if i != pair_idx and p[0] != eng and p[1] != tgt
            ][:3]
            while len(distractors) < 3:
                distractors.append("---")
            opts = [eng] + distractors[:3]
            ...
            # The threshold used to be `len(tgt) > 3`, which is a Latin-script
            # assumption: CJK words are 2-3 characters, so every Japanese,
            # Korean and Chinese entry fell through to the else branch and got a
            # prompt of "_____ (Gloss)" — the blank was the entire answer, with
            # no stem to reason from. That produced 549 unusable rows, 500 of
            # them in ja/ko/zh.
            #
            # Any word of 2+ characters can carry a blank; only a single
            # character genuinely cannot, and those become cloze_deletion, whose
            # prompt format is honest about the blank being the whole answer.
            if len(tgt) > 1:
                cut = max(1, len(tgt) // 2)
                # Never start the blank on a space: splitting "Buenas tardes" at
                # the midpoint used to yield the answer " tardes", so the learner
                # had to type a leading space to be marked correct. Walk the cut
                # forward past any whitespace so the stem keeps it instead.
                while cut < len(tgt) - 1 and tgt[cut] == " ":
                    cut += 1
                blank_word = tgt[cut:]
                prompt = f"{tgt[:cut]}_____ ({eng})"
                exercises.append((ex_type, prompt, blank_word, None, None))
            else:
                prompt = f"Fill in the missing word: _____ means {eng}"
                exercises.append(("cloze_deletion", prompt, tgt, None, None))
            ...
            # Substituting a fixed 'x' at index 2 silently produced NO error
            # whenever the word already had an 'x' there — "Puxar a perna de
            # alguém" was shipped as its own unaltered answer, so the exercise
            # was unsolvable. Pick a substitute that differs from what it
            # replaces.
            if len(tgt) > 4:
                marker = "x" if tgt[2] != "x" else "q"
                error_sent = tgt[:2] + marker + tgt[3:]
            else:
                error_sent = tgt + "x"
