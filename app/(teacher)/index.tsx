    ...
    return (
      <GradientBackground>
        <SafeAreaView className="flex-1 justify-center items-center px-6">
          <Ionicons name="school-outline" size={64} color="#7A756B" />
          <Text
    ...
    <GradientBackground>
      <SafeAreaView className="flex-1" edges={['top']}>
        <ScrollView
          ...
          refreshControl={
            <RefreshControl refreshing={loading} onRefresh={refresh} tintColor="#E0BE6B" />
          }
        >
          {/* Header */}
          <Text
          ...
          {loading ? (
            ...
            <>
              ...
              {error && (
                ...
                >
                  <Ionicons name="warning-outline" size={18} color="#D9913C" />
                  <Text
              ...
              {upcoming.length === 0 ? (
                ...
                >
                  <Ionicons name="calendar-outline" size={28} color="#7A756B" />
                  <Text
              ...
              {activity.length === 0 ? (
                <GlassSurface
                  ...
                  innerStyle={{ padding: 20, alignItems: 'center' }}
                >
                  <Ionicons name="pulse-outline" size={28} color="#7A756B" />
                  <Text
                    className="text-sm text-text-secondary mt-2"
                    style={{ fontFamily: 'Nunito_400Regular' }}
                  >
                ...
                activity.slice(0, 5).map((event) => (
                  <View
                    ...
                    style={{ gap: 10 }}
                  >
                    <Ionicons name={event.icon} size={18} color="#7A756B" />
                    <Text
