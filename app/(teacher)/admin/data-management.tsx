    ...
    <GradientBackground>
      <SafeAreaView className="flex-1" edges={['top']}>
        ...
        >
          ...
          {/* Export Section */}
          <Text className="text-xl text-text-primary mb-3" style={{ fontFamily: 'Nunito_600SemiBold' }}>
            Export All Data
          </Text>
          <GlassSurface style={{ marginBottom: 24 }} innerStyle={{ padding: 16 }}>
            <Text className="text-sm text-text-secondary mb-4" style={{ fontFamily: 'Nunito_400Regular' }}>
            ...
            {exportResult && (
              <View className="mt-4">
                <View className="flex-row items-center mb-2" style={{ gap: 6 }}>
                  ...
                  <Text style={{ color: '#3FB950', fontSize: 13, fontFamily: 'Nunito_500Medium' }}>
                    Export ready
                  </Text>
                </View>
                <Text className="text-sm text-text-secondary mb-3" style={{ fontFamily: 'Nunito_400Regular' }}>
                ...
                <View className="flex-row" style={{ gap: 10 }}>
                  ...
                  >
                    <Ionicons
                      ...
                      size={16}
                      color={copiedExport ? '#3FB950' : '#C9CDD2'}
                    />
                    <Text
                      style={{
                        color: copiedExport ? '#3FB950' : '#C9CDD2',
                  ...
                  >
                    ...
                    <Text style={{ color: '#C9CDD2', fontSize: 14, fontFamily: 'Nunito_600SemiBold' }}>
                      Share
                    </Text>
                  </Pressable>
                </View>
          ...
          {/* Danger Zone */}
          <Text className="text-xl mb-3" style={{ fontFamily: 'Nunito_600SemiBold', color: '#F85149' }}>
            Danger Zone
          </Text>
          <GlassSurface
          ...
          >
            <View className="flex-row items-center mb-3" style={{ gap: 8 }}>
              <Ionicons name="warning-outline" size={20} color="#F85149" />
            ...
            <Text className="text-sm text-text-secondary mb-2" style={{ fontFamily: 'Nunito_500Medium' }}>
            ...
            <Pressable
              ...
              style={{
                backgroundColor: confirmText === organization?.name ? '#F85149' : 'rgba(239, 68, 68, 0.3)',
                paddingVertical: 14,
                borderRadius: 12,
                alignItems: 'center',
            ...
            >
              {deleting ? (
                ...
                <Text style={{ color: '#FFFFFF', fontSize: 16, fontFamily: 'Nunito_600SemiBold' }}>
                  Permanently Delete
                </Text>
              )}
            </Pressable>
