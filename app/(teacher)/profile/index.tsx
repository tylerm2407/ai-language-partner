        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Ionicons name="swap-horizontal" size={20} color="#C9CDD2" />
              </View>
          ...
          >
            <View className="flex-row items-center">
              ...
              >
                <Ionicons name="person" size={24} color="#C9CDD2" />
              </View>
              <View className="ml-4">
                <Text
          ...
          {organization && (
            <>
              ...
              <View className="bg-dark-card rounded-2xl p-5 mb-4">
                <View className="flex-row items-center">
                  <Ionicons name="school" size={24} color="#C9CDD2" />
          ...
          >
            <Ionicons name="card" size={24} color="#C9CDD2" />
            <View className="ml-4 flex-1">
              <Text
                className="text-base text-text-primary"
                style={{ fontFamily: 'Nunito_600SemiBold' }}
          ...
          >
            <Ionicons name="settings" size={24} color="#C9CDD2" />
            <View className="ml-4 flex-1">
              <Text
                className="text-base text-text-primary"
                style={{ fontFamily: 'Nunito_600SemiBold' }}
