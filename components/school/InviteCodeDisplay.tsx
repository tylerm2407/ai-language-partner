  ...
  return (
    <GlassSurface innerStyle={{ padding: 20 }}>
      ...
      <View className="flex-row items-center mb-3">
        <View
          style={{
            ...
            height: 8,
            borderRadius: 4,
            backgroundColor: active ? '#4E9F6B' : '#7A756B',
            marginRight: 6,
          }}
        />
        <Text
          style={{
            color: active ? '#4E9F6B' : '#7A756B',
            fontSize: 12,
      ...
      <View className="flex-row items-center justify-center" style={{ gap: 12 }}>
        ...
        >
          <Ionicons name="copy-outline" size={16} color="#E0BE6B" />
          <Text
            style={{
              color: '#E0BE6B',
              fontSize: 14,
        ...
        {onRegenerate && (
          ...
          >
            <Ionicons name="refresh-outline" size={16} color="#C0555F" />
            <Text
              style={{
                color: '#C0555F',
                fontSize: 14,
