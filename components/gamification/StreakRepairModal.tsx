          ...
          >
            <View style={{ borderRadius: 22.5, padding: 32, alignItems: 'center', backgroundColor: '#151921' }}>
              ...
              {freezesAvailable > 0 ? (
                ...
                >
                  <LinearGradient
                    colors={[colors.streak.base, colors.streak.fire]}
                    start={GRADIENT_START}
                    end={GRADIENT_END}
                ...
                <View style={{ width: '100%', marginBottom: 12 }}>
                  <Text style={{ color: colors.text.quaternary, fontSize: 14, textAlign: 'center', marginBottom: 12 }}>
              ...
              >
                <Text style={{ color: colors.text.quaternary, fontSize: 16 }}>Start fresh</Text>
              </Pressable>
            </View>
          </LinearGradient>
        </View>
