/**
 * Ui2Mascot — the UI 2.0 screens' handle on the mascot.
 *
 ...
 * a 700 ms tick, so it must stay small. `celebrate` is the big one (the mascot rears
...
export function Ui2Mascot({ size = 96, mood = 'idle' }: Ui2MascotProps) {
